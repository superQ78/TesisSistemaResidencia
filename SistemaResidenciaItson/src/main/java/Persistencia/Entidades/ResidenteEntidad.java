...
public class ResidenteEntidad {
    ...
    public ResidenteEntidad(String nombreCompleto, String sexo, LocalDate fechaNacimiento, String domicilio, String curp, String lugarResidencia,
            ...
            String parentescoEmergencia, String domicilioEmergencia, String lugarEmergencia, String celularEmergencia, String telefonoEmergencia,
            String correoEmergencia, String nombreTutor, String parentescoTutor, String domicilioTutor, String lugarTutor, String celularTutor,
            String telefonoTutor, String correoTutor, String estadoSalud, boolean tieneDeficienciaVista, String especificarVista,
            boolean tieneDeficienciaAuditiva, String especificarAuditiva, boolean tieneDiscapacidadFisica, String especificarFisica,
            boolean tieneLesionesGraves, String especificarLesiones, boolean tienePadecimientos, String especificarPadecimientos,
            boolean tieneTratamientosPsicologicos, String motivoTratamientosPsicologicos, boolean tieneMedicamentosControlados, String especificarMedicamentos,
            boolean tieneAlergias, String especificarAlergias, boolean tieneTratamientosExternos, String motivoTratamientosExternos, String tipoSangre,
            String aspectosSaludMejora, String otraInformacionSalud, boolean haVividoFuera, String tiempoVividoFuera, String decisionResidencia,
            String razonesVivirResidencia, String adaptacion, String estiloConvivencia, String situacionesNoDeseadas, boolean buscaCompaneroExtranjero,
